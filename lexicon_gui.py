...
class LexGUI:
    ...
    def createTabs(self):
        ...
        self.tabControl.add(self.tab1, text = 'Organize')
    ...
    def createTab1(self):
        ...
        self.labelFrame = ttk.LabelFrame(self.tab1, text= 'Select output directory:')
    ...
    def createTab3(self):
       ...
       #textbox 31
        ...
        #button 31
        self.button31 = ttk.Button(self.labelFrame3, text = "Browe Directory", 
            command=self.dirDialog3)
        self.button31.grid(column = 1, row = 3, sticky = "w")
 

        #label 31
        self.label31 = ttk.Label(self.labelFrame3, text="Select Special Directory:")
